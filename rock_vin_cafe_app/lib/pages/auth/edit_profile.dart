...
class EditProfile extends StatefulWidget {
  const EditProfile({super.key, required this.btnName});
...
class _EditProfileState extends State<EditProfile> {
  ...
  Future<void> loadData() async {
    ...
    if (widget.btnName == "Update Profile") {
      Database database = new SQLDatabase();

      UserModel user =
          await database.readUserData("user", auth.currentUser!.uid);
  ...
  Widget build(BuildContext context) {
    ...
    _fnameController.text = auth.currentUser!.phoneNumber == null
        ? ""
