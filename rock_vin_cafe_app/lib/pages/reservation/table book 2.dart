...
class TableBookingPagetwo extends StatefulWidget {
  const TableBookingPagetwo({super.key});

  @override
  _TableBookingPagetwoState createState() => _TableBookingPagetwoState();
}

class _TableBookingPagetwoState extends State<TableBookingPagetwo> {
  int selectedTable = 0;
