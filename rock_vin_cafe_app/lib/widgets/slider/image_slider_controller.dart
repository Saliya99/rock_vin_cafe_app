...
import 'package:rock_vin_cafe_app/widgets/slider/indi.dart';
import 'package:rock_vin_cafe_app/widgets/slider/narrow.dart';
import 'package:rock_vin_cafe_app/widgets/slider/slide_w.dart';

class FanCarouselImageSliderCustom extends StatefulWidget {
  const FanCarouselImageSliderCustom({
    super.key,
  ...
  final Function(String)? onImageClick; // New property for image click callback
  ...
  /// The initial page to show when first creating the [FanCarouselImageSliderCustom].
  /// Defaults to 1.
  ...
  /// This Duration type value, use for all animations in [FanCarouselImageSliderCustom].
  ...
  @override
  State<FanCarouselImageSliderCustom> createState() =>
      _FanCarouselImageSliderCustomState();
}

class _FanCarouselImageSliderCustomState
    extends State<FanCarouselImageSliderCustom> {
            ...
            children: [
              ...
              Visibility(
                ...
                child: ValueListenableBuilder(
                  valueListenable: _currentIndex,
                  builder: (context, value, child) => IndicatorsWidgetCustom(
  ...
  _goPrevPage() async {
    ...
    if (widget.onImageClick != null) {
      widget.onImageClick!(widget.imagesLink[_currentIndex.value]);
    }
  }
}
